...
##########################################################
def protein():
    res = ["GLY", "ALA", "VAL", "LEU", "ILE", "CYS", "MET", "PRO", "PHE", "TRP", "TYR", "HIS", "LYS", "ARG", "ASP", "GLU", "ASN", "GLN", "THR", "SER", "MSE"]
...
##########################################################
def dnarna():
    res = ["A", "G", "C", "T", "DA", "DG", "DC", "DT", "DI", "U", "I", "ADE", "THY", "GUA", "CYT", "URA"]
...
def get_software_version(logfile, progid, dic):
    ...
    for x in fp:
        ...
        elif ("PDBREP" in progid.upper() or "PDBCAL" in progid.upper()) and "REMARK   3   PROGRAM     : " in x:
