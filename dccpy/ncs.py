...
def check_ncs_cif(file):
    ...
    if dom : tmp1(ens_id, dom.keys(), 'struct_ncs_dom')
    if lim : tmp1(ens_id, lim.keys(), 'struct_ncs_dom_lim')
    if res : tmp1(ens_id, res.keys(), 'refine_ls_restr_ncs')
